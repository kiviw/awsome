 ...
 * Description: A simple plugin for manual deposit disbursement and status management.
 * Version: 1.0.0
 * Author: Your Name
...
function manual_deposit_form_shortcode() {
    ...
    <div class="manual-deposit-form">
        ...
        <form method="post">
            ...
            <label for="tx_hash">Blockchain Transaction Hash (Optional):</label>
            <input type="text" id="tx_hash" name="tx_hash" />
